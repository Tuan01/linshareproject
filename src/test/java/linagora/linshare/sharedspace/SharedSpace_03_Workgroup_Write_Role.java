...
public class SharedSpace_03_Workgroup_Write_Role extends BaseTest {
    WebDriver driver;
    ...
    @Test
    public void SharedSpace_04_User_Can_Add_Member_With_Writer_Right(){
        ...
        sharedspacePage.selectToRoleMemberInDropdownList("Writer");
        ...
        verifyTrue(sharedspacePage.viewMemberAndRole("Peter WILSON", "Writer"));
